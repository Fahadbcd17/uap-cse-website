      ...
      <div v-if="clubEvents.length > 0" class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
        ...
        <div class="space-y-4">
          ...
          >
            ...
            <a href="https://docs.google.com/forms/d/1f8FHNNlEZSTRfi4h-AYgrnA0f2VoEOPeWh-C6XtRmS0/edit" target="_blank" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors duration-200 text-sm font-semibold flex-shrink-0">
              Register
            </a>
          </div>
        </div>
